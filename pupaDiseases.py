...
def DiseaseTreatment():
    ...
    for x in items:
        ...
        print(" Last  "+str(hour_in_a_day)," days",x," hours ago.")
        print(" Date:", today,"\n")
        if itm>=0 and itm<=20:
            print(" Classification of Butterfly   : ", items[itm])
            print( " Predicted Pupa    :",items[itm], "  Percent :" , random.randint(0,100),"%")
            print(" Classification Disease Code   : #", itm)
            print(" PREDICTED DISEASE : ",diseases[itm])
